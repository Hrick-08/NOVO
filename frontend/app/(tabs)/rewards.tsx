...
export default function RewardsScreen() {
  ...
  const loadData = async (forceRefresh = false) => {
    try {
      ...
      // Purchase history has no cache yet — always fetch fresh but don't block UI
        ...
        <View style={styles.section}>
          ...
          {loadingPurchases && purchases.length === 0 ? (
            ...
            <View style={[styles.emptyBox, { backgroundColor: colors.card, borderColor: colors.border }]}>
              ...
              <Text style={[styles.emptyBoxSub, { color: colors.icon }]}>
                Spend your coins in the Shop tab!
              </Text>
            </View>
          ) : (
            purchases.map((p) => (
              ...
              >
                ...
                <View style={styles.purchaseRight}>
                  <Text style={[styles.purchaseCoins, { color: '#f59e0b' }]}>
                    -{p.coins_spent} 🪙
                  </Text>
                  <Text style={[styles.purchaseStatus, { color: purchaseStatusColor(p.status) }]}>
                    {p.status}
                  </Text>
                </View>
              </View>
          ...
          <View style={styles.section}>
            ...
            {history.map((item, i) => (
              ...
              >
                ...
                <Text style={[styles.historyCoins, { color: '#f59e0b' }]}>
                  +{item.coins_earned} 🪙
                </Text>
              </View>
            ))}
...
const styles = StyleSheet.create({
  ...
  purchaseRow: {
    ...
    padding: 14, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, marginBottom: 8,
  },
  purchaseIcon: {
